...
Nx=90;                  %% Meshing point in x-direction
Ny=70;                  %% Meshing point in y-direction
Mx=20e-9;               %% map X [m]
My=20e-9;               %% map Y [m]
...
if PWE_Method==1
    ...
    NGx = 10;%Nx/2-1  ;    % number of harmonics % must be at least 2 times -1 smaller than Nz (smaller => faster)
    NGy = 11;%Ny/2-1  ;    % number of harmonics % must be at least 2 times -1 smaller than Nz (smaller => faster)
